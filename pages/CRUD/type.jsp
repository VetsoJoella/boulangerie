        ...
        <div class="col-lg">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form method="post" action="${pageContext.request.contextPath}/CRUD/type">
                  <div class="row mb-3">
                  ...
                  <% if(types!=null && types.length>0) {
                    for(Type type : types){ %>
                          <tr>
                            ...
                            <td><%= type.getNom() %></td>
                            <td><a href="${pageContext.request.contextPath}/CRUD/type?idType=<%= type.getId() %>"><i class="bi bi-trash" ></i></a></td>
                          </tr>
                    <% } %>
                  <% } %>
