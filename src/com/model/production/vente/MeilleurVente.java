...
public class MeilleurVente {
    ...
    public void setVentes(Connection connection) throws Exception {
        ...
        System.out.println("Début "+getDateDebut()+" Date fin "+getDateFin());
    }

    public MeilleurVente(String dateDebut, String dateFin) {
        setDateDebut(dateDebut);
        setDateFin(dateFin);
        System.out.println("Valeur de début est "+getDateDebut()+" Date fin est "+getDateFin());
    }
}
